      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <h3 className="text-sm font-medium text-blue-800 mb-2">
            💡 Petunjuk untuk Administrator
          </h3>
          <ul className="text-xs text-blue-700 space-y-1">
            <li>• Gunakan username dan password yang telah diberikan</li>
            <li>• Setelah login, Anda dapat mengelola semua konten website</li>
            <li>• Interface admin dirancang mudah digunakan tanpa perlu keahlian teknis</li>
          </ul>
        </div>
      </div>
    </div>
